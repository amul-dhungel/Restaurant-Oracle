<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerOrderDetails.aspx.cs" Inherits="CWOracleWebForms.Complex_WebForms.CustomerOrderDetails" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:DropDownList ID="customerDropDown" runat="server" DataSourceID="SqlDataSource1" DataTextField="NAME" DataValueField="CUSTID"></asp:DropDownList>
        ...
        <div>
            ...
            <asp:DropDownList ID="addressDropDown" runat="server"></asp:DropDownList>
        </div>
        <div>
